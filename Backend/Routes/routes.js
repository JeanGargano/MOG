...
import { encargadoController, encuestaController, comedorController } from "../Container.js";
...
router.get('/getEncargado', (req, res) => encargadoController.findByIdentificacion(req, res));
router.post('/crearEncargado', (req, res) => encargadoController.postEncargado(req, res));
router.post('/agregarCampos', (req, res) => encargadoController.agregarCampos(req, res));
router.post('/login', (req, res) => encargadoController.logearEncargado(req, res));

//Endpoints para Comedor
router.post('/crear_comedor', (req, res) => comedorController.postComedor(req, res));
router.get('/listar_comedores', (req, res) => comedorController.findComedores(req, res));
